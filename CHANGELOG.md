...
- **deps**: update flyway to v11.20

## v8.1.7 (2025-12-08)

### Fix

- **deps**: update flyway to v11.19
...
- **deps**: update flyway to v11.16

## v8.1.2 (2025-10-23)

### Fix

- **deps**: update flyway to v11.15
...
- **deps**: update flyway/flyway docker tag to v11.12
...
- **deps**: update flyway/flyway docker tag to v11.8
...
- **deps**: update flyway/flyway docker tag to v11.6

## v7.0.3 (2025-03-28)

### Fix

- **deps**: update flyway/flyway docker tag to v11.5

## v7.0.2 (2025-03-15)

### Fix

- **deps**: update flyway/flyway docker tag to v11.4

## v7.0.1 (2025-01-31)

### Fix

- **deps**: update flyway/flyway docker tag to v11.3
- **deps**: update flyway/flyway docker tag to v11.2
